  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        {/* Header */}
        <div className="flex flex-col sm:flex-row justify-between items-center mb-10 px-6 sm:px-20">
          <h1 className="text-3xl sm:text-4xl font-bold mb-4 sm:mb-0 text-white text-center sm:text-left">
            What we Offer?
          </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-6 sm:px-20">
          {/* Card 1 */}
          <div className="border-2 p-6 rounded-2xl shadow-lg bg-white/90 hover:scale-105 transition">
