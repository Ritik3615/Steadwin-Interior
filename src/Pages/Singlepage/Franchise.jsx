    ...
    <div className="w-full bg-gray-50 text-gray-900">
      ...
      <section className="py-12 px-6 md:px-20">
        ...
        <p className="text-lg leading-relaxed text-gray-700 max-w-4xl">
          ...
          industrial projects need stainless steel, glass, aluminum, and modular
          railing systems. Our brand gives you premium designs, manufacturing
          support, installation training, and powerful marketing systems so you
          can grow faster with minimum risk.
        </p>
      </section>
      ...
      <section className="py-12 px-6 md:px-20 bg-white">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {[
            ...
            >
              <h3 className="text-xl font-bold">{i + 1}</h3>
      ...
      >
        <div className="bg-white/85 backdrop-blur-md max-w-3xl mx-auto p-10 rounded-xl shadow-lg">
