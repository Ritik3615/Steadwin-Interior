...
function ContactSidebar() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed right-0 top-1/2 -translate-y-1/2 z-20 text-white w-10 md:w-12 h-72 flex flex-col justify-between rounded-l-2xl transition-transform duration-500 ease-in-out overflow-visible ${
          isOpen
